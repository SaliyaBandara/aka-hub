...
class createModel extends Model
{
    ...
    public function notification($type, $id, $user_id, $title, $message, $target = 0, $link = "")
    {
        ...
        $this->model("createModel")->notification(7, 0, $id, "Student Representative Permissions Revoked","Sorry , Your Student Representative Permissions and Features Revoked", 7);
        ...
        $this->model("createModel")->notification(7, $values["id"], $id, "Counselor Account Created for  mail " . $values["email"], "Counselor Account Created for email " . $values["email"] . " . Your Password will be " . $values["password"] . " . Please login to the system and change your password. ", 7);
