...
<div id="sidebar-active">
    ...
    <div class="main-grid flex">
        <div class="left">
            <h3 class="h3-userDistribution">User Distribution in the System</h3>
            <div class="divUserDistribution">
                <div class="userCardsContainor">
        ...
        <div class="right">
            <div class="textAndLabelContainor">
                        ...
                        <div class="mwb-form-main-container">
                            <form action="#">
                                <div class="mwb-form-group">
                                    ...
                                    <label for="name" class="mwb-form-text-label">Index Number*</label>
                                    <div class="mwb-form-error">This Field Required*</div>
                                </div>
                                <div class="mwb-form-group">
                                    <input type="email" class="mwb-form-control" id="email">
                                    <label for="email" class="mwb-form-text-label">University Email*</label>
                                    <div class="mwb-form-error">This Field Required*</div>
                                </div>
                                <div class="mwb-form-group">
                                    <input type="text" class="mwb-form-control" value="" id="name">
                                    <label for="name" class="mwb-form-text-label">Registration Number*</label>
                                    <div class="mwb-form-error">This Field Required*</div>
                                </div>
                                <div class="mwb-form-group">
                                    <input type="email" class="mwb-form-control" id="email">
                                    <label for="email" class="mwb-form-text-label">National Identity Card*</label>
                                    <div class="mwb-form-error">This Field Required*</div>
                                </div>
                                <div class="mwb-form-group">
                                    <input type="Submit" class="mwb-form-submit-btn" value="Find User">
                                </div>
                            </form>
                        </div>
                    </div>
