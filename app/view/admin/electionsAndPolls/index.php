    ...
    <div class="main-grid flex">
        <div class="left">
            <div class="divTileRow">
                <div class="divTile">
                    <a href="<?= BASE_URL ?>/election/electionCreate/index" class="mwb-form-submit-btn">Create Elections</a>
                </div>
                <div class="divTile">
            ...
            <div class="divTileRow">
                <div class="divTile">
                    <a href="<?= BASE_URL ?>/poll/pollCreate/index" class="mwb-form-submit-btn">Create Polls</a>
                </div>
                <div class="divTile">
