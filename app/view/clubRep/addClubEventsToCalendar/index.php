...
// $header = new header();
$sidebar = new Sidebar("addClubEventsToCalendar");
?>
    ...
    <div class="main-grid flex">
        <div class="left">
            <div class="divAddCounselors">
                <h3>Add Club Events to Calendar</h3>
                            ...
                            <div class="mwb-form-main-container">
                                <form action="#">
                                    <div class="mwb-form-group">
                                        <input type="text" class="mwb-form-control" value="" id="name" placeholder="Event Title*">
                                    ...
                                    <div class="mwb-form-group" id="dateAndTimeContainor">
                                        ...
                                        <div>
                                            <label for="Club">University Club: </label>
                                            <select>
                                                <option value="option1">ACM UCSC</option>
                                                <option value="option2">IEEE Student Branch</option>
                                                <option value="option3">Rotaract Club</option>
                                                <option value="option4">Isaca Student Branch</option>
                                            </select>
                                    ...
                                    <div class="mwb-form-group">
                                        <input type="text" class="mwb-form-control" value="" id="name" placeholder="Event Description">
                                        <div class="mwb-form-error">This Field Required*</div>
                                    </div>
                                    <div class="mwb-form-group">
                                        <input type="email" class="mwb-form-control" id="email" placeholder="Event Location">
                                        <div class="mwb-form-error">This Field Required*</div>
                                    </div>
                                    <div class="mwb-form-group">
                                        <input type="Submit" class="mwb-form-submit-btn" value="Add Event to Calendar">
                                    </div>
                                </form>
                            </div>
                        </div>
