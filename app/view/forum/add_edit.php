...
<div id="sidebar-active" class="hideScrollbar">
    ...
    <div class="my-2 mx-2">
        <h3 class="text-muted"><?= $data["action"] == "create" ? "Create New Forum Post" : "Edit Forum Post" ?></h3>
        ...
        <form action="" method="post" class="form">
            ...
            <div class="mb-1 form-group">
                ...
                <textarea name="content" id="content" class="form-control" placeholder="Enter Post Content" data-validation="required"><?= $data["item"]["content"] ?></textarea>
            </div>
            ...
            <div class="mb-1">
                ...
                <div action="/uploadFiles/img/forum_post_img" data-name="cover_img" data-maxFiles="1" class="dropzone imgDropZone"></div>
            </div>
            ...
            <div class="mt-1-5 form-group">
                <a href="<?= BASE_URL ?>/forum" class="btn btn-info">Back</a>
