...
<div id="sidebar-active" class="hideScrollbar">
    ...
    <script>
        ...
        //    get url seperate by / and get last element
        let counselor_id = window.location.href.split('/').pop();


        setInterval(() => {
            let xhr = new XMLHttpRequest();
            xhr.open("GET", `${BASE_URL}/counselorView/getChatHTML/${counselor_id}`, true);
            xhr.onload = () => {
        ...
        document.querySelector(".typing-area").addEventListener("submit", function(event) {
            ...
            if (message !== "") {
                sendChatMessage(counselor_id, message);
                messageInput.value = "";
            }
        });
